...
const Sidebar = ({ isOpen, onClose, collapsed = false }) => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      current: location.pathname === '/workflow-config'
    },
    {
      name: 'Settings',
      href: '/settings',
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out lg:hidden ${
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200">
            <div className="mobile-brand flex items-center space-x-2">
              <img
      ...
      <div className={`hidden lg:fixed lg:inset-y-0 lg:flex lg:flex-col transition-all duration-300 ${
        ...
        <div className="flex flex-col flex-grow bg-white border-r border-gray-200">
          ...
          <nav className="flex-1 px-4 py-6 space-y-2">
            {navigation.map((item) => (
              <Link
                key={item.name}
                to={item.href}
                className={`flex items-center px-3 py-3 rounded-lg text-sm font-medium transition-colors duration-200 group ${
              ...
              >
                <div className={`${collapsed ? 'w-6 h-6' : 'w-5 h-5'} flex-shrink-0`}>
                  {item.icon}
                </div>
          ...
          <div className="p-4 border-t border-gray-200">
            <button
              onClick={toggleTheme}
              className={`w-full flex items-center px-3 py-3 rounded-lg text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-100 transition-colors duration-200 ${
                collapsed ? 'justify-center' : 'space-x-3'
              }`}
